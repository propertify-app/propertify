...
import { addressAutocompleteMolecule } from './molecule';
...
export default function AddressDialog(
  ...
  const { children, dialogTitle, open, adrAddress, setOpen, isLoading } = props;

  const { addressAtom } = useMolecule(addressAutocompleteMolecule);
