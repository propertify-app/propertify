...
export default function SignInPage() {
  return (
    <motion.div className="grid w-full grow items-center px-4 sm:justify-center opacity-0" animate={{
      opacity: 1
    }}>
      <SignIn.Root>
        <Clerk.Loading>
          {(isGlobalLoading) => (
            <>
              <SignIn.Step name="start">
                <Card className="w-full sm:w-192 sm:grid sm:grid-cols-2">
                  <div>
                    <CardHeader>
                      <CardTitle>Sign in to Propertify</CardTitle>
                  ...
                  <motion.div className="bg-primary rounded-r-lg p-12 flex flex-col gap-6 justify-center" layoutId="auth">
                    <h4 className="text-sm font-semibold text-white tracking-wide">PROPERTIFY</h4>
                    <h1 className="text-6xl text-white font-bold">Welcome <br/> back</h1>
                  </motion.div>
                </Card>
              </SignIn.Step>
